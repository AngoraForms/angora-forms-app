...
const nextDev = async (argv)=>{
    ...
    if (args["--turbo"]) {
        var _rawNextConfig_experimental, _defaultConfig_experimental, _rawNextConfig_experimental1, _rawNextConfig_experimental2;
        isTurboSession = true;
        ...
        let server = bindings.turbo.startDev({
            ...
            root: args["--root"] ?? ((_rawNextConfig_experimental2 = rawNextConfig.experimental) == null ? void 0 : _rawNextConfig_experimental2.outputFileTracingRoot)
        });
