...
const _abortcontroller = require("next/dist/compiled/@edge-runtime/primitives/abort-controller");
...
class Telemetry {
    constructor({ distDir  }){
        ...
        this.flushDetached = (mode, dir)=>{
            ...
            (0, _child_process.spawn)(process.execPath, [
        ...
        this.submitRecord = (_events)=>{
            ...
            const postController = new _abortcontroller.AbortController();
