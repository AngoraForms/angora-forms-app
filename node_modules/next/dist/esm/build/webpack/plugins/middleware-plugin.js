...
function getExtractMetadata(params) {
    ...
    return async ()=>{
         ...
         */ if (!dev && buildInfo.usingIndirectEval && isUsingIndirectEvalAndUsedByExports({
                    ...
                    if (!isDynamicCodeEvaluationAllowed(module.userRequest, edgeFunctionConfig == null ? void 0 : edgeFunctionConfig.config, rootDir)) {
