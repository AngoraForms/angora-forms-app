...
export declare const createWorker: (serverPort: number, ipcPort: number, ipcValidationKey: string, isNodeDebugging: boolean | 'brk' | undefined, type: 'pages' | 'app', useServerActions?: boolean) => any;
