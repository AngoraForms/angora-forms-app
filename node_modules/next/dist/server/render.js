...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    renderResultMeta.devOnlyCacheBusterQueryString = renderOpts.dev ? renderOpts.devOnlyCacheBusterQueryString || `?ts=${Date.now()}` : "";
    ...
    const devOnlyCacheBusterQueryString = renderResultMeta.devOnlyCacheBusterQueryString;
