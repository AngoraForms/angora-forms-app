...
const buffer = Buffer.from(${JSON.stringify((await _fs.default.promises.readFile(resourcePath.replace(_discover.METADATA_RESOURCE_QUERY, ""))).toString("base64"))}, 'base64'
  )
