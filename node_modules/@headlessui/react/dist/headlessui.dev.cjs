...
function DialogFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    ...
    /* @__PURE__ */ import_react29.default.createElement(Hidden, { features: 4 /* Hidden */, ref: mainTreeNode })
  );
}
...
function TransitionChildFn(props, ref) {
  ...
  let [state, setState] = (0, import_react41.useState)(show ? "visible" /* Visible */ : "hidden" /* Hidden */);
