...
<button (click)='decrement()'>Decrement</button>`;
  ...
  const incrementDisabled = `increment() {
    this.value++;
    this.onChange(this.value);
    this.onTouched();
    if (this.value === 5) {
  ...
  const fullExample = `class CustomComponent {
    template = \`
          <h1>{{value}}</h1>
          <button (click)='increment()'>Increment</button>
          <button (click)='decrement()'>Decrement</button>
    ...
    <article className="bg-primary">
      <section className="flex flex-col items-center justify-center bg-primary mt-20">
        <div className="bg-white rounded-lg p-5 mt-5 w-3/4 mt-10">
          ...
          <br></br>
          <p className="text-xl">
            After completing the steps below, before using 'ng serve' to
            generate your Angular webpage, run 'npx webpack' to generate your
            custom components.
          </p>
          <br></br>
          <p className="text-xl">
            Reference custom component in your own form using class name Kebab
            Cased
          </p>
        ...
        <div className="bg-white rounded-lg p-5 mt-5 w-3/4 mt-10">
          ...
          <p className="text-xl">
            Create a webpack.config.ts file in the root directory of your
            project and follow the structure above
          </p>
        </div>
        <div className="bg-white rounded-lg p-5 mt-5 w-3/4">
          ...
          <ul>
            ...
            <li className="m-5">
              ...
              <br></br> Include all html code in backticks (``) in the template
              property.
              <SyntaxHighlighter language="typescript">
                {HTML}
              </SyntaxHighlighter>
            ...
            <hr></hr>
            <li className="m-5">
              <span className="text-xl">Value</span> <br></br> Set equal the
              value of the form component inside custom functionality. When
              changed invoke OnChange.
              <SyntaxHighlighter language="typescript">
                {'<h1>{{value}}</h1>'}
              </SyntaxHighlighter>
              <SyntaxHighlighter language="typescript">
            ...
            <hr></hr>
            <li className="m-5">
              <span className="text-xl">Disabled</span> <br></br> Set equal to
              the disabled property in the HTML code for inputs/buttons.
              Determines whether inputs/buttons are disabled. Set to false to
              enable. Set to true to disable.
              <SyntaxHighlighter language="typescript">
                {
            ...
            <hr></hr>
            <li className="m-5">
              <span className="text-xl">Export</span> <br></br> Export your
              customComponent/s using module.exports
              <SyntaxHighlighter language="typescript">
                {'module.exports = [CustomComponent]'}
              </SyntaxHighlighter>
            </li>
            <hr></hr>
            <li className="m-5">
              Write additional code (properties and/or functions) to provide
